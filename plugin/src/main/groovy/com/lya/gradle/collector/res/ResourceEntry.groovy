...
class ResourceEntry {
    ...
    @Override
    String toString() {
        return 'ResourceEntry resourceType: ' + resourceType + ' resourceName: ' + resourceName + ' resourceId: 0x' + Integer.toHexString(resourceId) + ' newResourceId: 0x' + Integer.toHexString(newResourceId)
    }
/**
